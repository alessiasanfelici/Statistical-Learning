...
```{r}
model_gam <- gam(diabetes ~ s(pregnant, df = 5) + s(glucose, df = 5) + s(pressure, df = 5) + 
                   s(triceps, df = 5) + s(insulin, df = 5) + s(mass, df = 5), s(pedigree, df = 5) + 
                   s(age, df = 5), data = train_data) # family = binomial())
