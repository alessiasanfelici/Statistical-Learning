...
- $employee\_residence$: primary country of residence of the employee during during the working year;
...
For the creation of a clearer summary table for categorical variables, some columns have been removed, since they were characterized by many different values with very low frequency (otherwise the table would be infinite). These columns are: $job_title$, $employee_residence$ and $company_location$.
...
- The bars overlap, making the trends confusing and difficult to understand and 
